(function ($) {
    ...
    $(function () {
        element.typed({
            strings: ["Software Developer", "Lifelong Learner", "Python Enthusiast", "Software Developer", "Audiophile", "Drummer", "Software Developer", "Eternal Optimist", "Board Game Collector"],
            typeSpeed: 170,
            loop: true,
            autoplay: true,
        });
